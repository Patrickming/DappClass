...
contract WETH9 {
    ...
    event DepositTo(address indexed from, address indexed toaddress, uint256 value);
    event Withdrawal(address indexed src, uint256 wad);
    event WithdrawalTo(address indexed from, address indexed toaddress, uint256 value);
